        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-6">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-lg font-semibold text-red-800">⚠️ CRITICAL DISCLAIMERS - READ FIRST</h3>
                <div className="mt-2 text-red-700">
                  <h4 className="font-semibold mb-2">FOR ENTERTAINMENT PURPOSES ONLY</h4>
                  <p className="mb-3">
                    The AI Board of Advisors platform and all content, recommendations, analyses, and outputs provided by our AI advisors are intended <strong>SOLELY FOR ENTERTAINMENT PURPOSES</strong> and should <strong>NEVER</strong> be relied upon for actual business, financial, legal, medical, or any other professional decisions.
                  </p>
                  <p className="font-semibold">
                    <strong>AI SYSTEMS CAN AND DO GENERATE FALSE INFORMATION</strong> (commonly known as "hallucinations"). Our AI advisors may confidently present completely fabricated facts, statistics, citations, and recommendations that have no basis in reality.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="prose max-w-none text-gray-800">
            <p className="text-sm text-gray-600 mb-6"><strong>Effective Date: January 16, 2025</strong></p>

            <h3 className="text-xl font-bold mb-4">1. ACCEPTANCE OF TERMS</h3>
            <p className="mb-4">
              By accessing or using the AI Board of Advisors platform ("Service"), you acknowledge that you have read, understood, and agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you must immediately cease all use of the Service.
            </p>
            ...
            <p className="mb-3">
              <strong>WE ASSUME ABSOLUTELY NO RESPONSIBILITY OR LIABILITY</strong> for any consequences, damages, losses, or harm of any kind arising from your use of this Service, including but not limited to:
            </p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h3 className="text-lg font-bold text-blue-800 mb-2">🎭 ENTERTAINMENT PRODUCT NOTICE</h3>
              <p className="text-blue-700">
                This Service is equivalent to a Magic 8-Ball, fortune cookie, or horoscope. It provides entertainment value through simulated business advisory conversations. Any resemblance to actual business advice is purely coincidental.
              </p>
            </div>
            ...
            <p className="mb-3">
              THE SERVICE IS PROVIDED <strong>"AS IS" AND "AS AVAILABLE"</strong> WITHOUT ANY WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:
            </p>
            <ul className="list-disc list-inside mb-6 space-y-1">
            ...
            <p className="mb-3">
              Do NOT upload or share any confidential, proprietary, or sensitive information. We make no guarantees about data security or confidentiality.
            </p>
            ...
            <p className="mb-6">
              Our total liability to you for any claims shall not exceed the amount you paid for the Service in the past twelve months, or $100, whichever is less.
            </p>

            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <h3 className="text-lg font-bold text-red-800 mb-2">FINAL WARNING</h3>
              <p className="text-red-700 font-semibold mb-3">DO NOT USE THIS SERVICE FOR ANYTHING IMPORTANT</p>
              ...
              <p className="text-red-700 font-semibold mt-3">
                Remember: This is an entertainment product. Treat it like a video game, not a business tool.
              </p>
            </div>

            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
              <h3 className="text-lg font-bold mb-2">12. CONTACT INFORMATION</h3>
              <p className="mb-2">For questions about these Terms (though we assume no obligation to respond):</p>
              <p className="mb-1"><strong>Email:</strong> legal@aiboardofadvisors.com</p>
              <p><strong>Response Time:</strong> If we feel like it</p>
            </div>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
              <p className="font-bold text-yellow-800 mb-2">
                BY USING THIS SERVICE, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO ALL OF THE ABOVE TERMS AND CONDITIONS.
              </p>
              <p className="text-yellow-700">
                Seriously, we mean it. This is for fun only. Do not stake your business, career, or financial future on what our AI advisors tell you. They're basically sophisticated random text generators wearing digital business suits.
              </p>
            </div>
