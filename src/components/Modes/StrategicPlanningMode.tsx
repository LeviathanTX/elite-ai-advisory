...
export const StrategicPlanningMode: React.FC<StrategicPlanningModeProps> = ({ onBack }) => {
  ...
  const topics = [
    { id: 'growth', name: 'Growth Strategy', description: 'Scaling your business and market expansion' },
    { id: 'funding', name: 'Fundraising', description: 'Preparing for investment rounds and investor relations' },
    { id: 'product', name: 'Product Strategy', description: 'Product development and market fit' },
    { id: 'competition', name: 'Competitive Strategy', description: 'Market positioning and competitive advantage' },
    { id: 'team', name: 'Team Building', description: 'Hiring, culture, and organizational development' },
    { id: 'operations', name: 'Operations', description: 'Efficiency, processes, and scaling operations' }
  ];
  ...
  const getAdvisorResponse = (advisorId: string, userInput: string, topic: string) => {
    ...
    if (!responses) return "That's an interesting perspective. Let me think about the implications...";
    
    const topicResponses = responses[topic as keyof typeof responses] || responses.growth || ["That's a great question. Let me share my thoughts..."];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Get insights from your advisory board on critical business decisions</p>
            </div>

            {/* Advisor Selection */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Choose Your Advisory Board ({selectedAdvisors.length} selected)</h2>
              <p className="text-sm text-gray-600 mb-4">Select advisors who will participate in your strategic planning discussion</p>
